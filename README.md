...
هذا التطبيق هو نظام ذكي لإدارة المفقودات والموجودات، يهدف إلى تسهيل عملية الإبلاغ عن الأشياء المفقودة أو التي تم العثور عليها داخل المجتمع. يتيح للمستخدمين إضافة تفاصيل دقيقة عن الأغراض المفقودة أو المعثور عليها، مع إمكانية تصفّح قائمة محدثة بالأغراض المتاحة.
